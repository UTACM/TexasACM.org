...
function showInfo(data) {
  ...
  table += '<a style="border-bottom: none" href="https://trello.com/b/2Qum6OQt/texasacm-finance" target="_blank"><button class="button special">View Kanban Board</button></a></center>';
	table += '</div>';
